...
<main class="main">
    ...
    <a href="" onclick="test()">Lien de test</a>
</main>
<section class="infos">
    <article class="info info--mail">
        <div class="info-header">
            <svg class="info-svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                 viewBox="0 0 16 16">
...
<article class="contact">
    ...
    <form class="form" onclick="test()" method="post">
        <ul class="form-container">
            ...
            <li class="form-field--message">
                <label class="form-labelContainer" for="content">
                    ...
                    <textarea class="form-input form-input--area" name="content" placeholder="Votre message" rows="5"
    ...
    <script type="text/javascript" src="<?php echo SCRIPTS; ?>jquery3.7.1.js" ></script>
    <script type="text/javascript" src="<?php echo SCRIPTS; ?>ajax.js" defer></script>
